...
console.log(LongestWord("Muzamil Fatima Meerab Maryam Chattha"))
// Problem: Count Vowels in a String
console.log("Problem: Count Vowels in a String")
...
console.log("Problem: Most Frequent Character in a String")
...
// find the maxcount char
console.log(mostFrequentChar("javascript"));
console.log(mostFrequentChar("hello worldmmmmmmmmmmmmmmmmmmm"));
